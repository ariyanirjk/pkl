...
$routes->get('PerjalananDinas', 'PerjalananDinas::index');
...
$routes->get('/Pengajuan', 'PengajuanController::index'); // Menampilkan daftar pengajuan
...
$routes->get('/Biaya', 'BiayaController::index');
