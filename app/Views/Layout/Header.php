...
<body class="app">
							...
							<a class="nav-link" href="<?= base_url('/Pegawai'); ?>">
								<span class="nav-icon">
									...
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-badge"
										...
										<path fill-rule="evenodd"
											d="M4.5 3a1 1 0 0 0-1 1V14a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H10v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V3H4.5zm3.5 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm-3 5a3 3 0 0 1 6 0H5z" />
								</svg>
							</span>
							...
							<a class="nav-link" href="<?= base_url('/PerjalananDinas'); ?>">
								<span class="nav-icon">
									...
									<svg width="1em" height="1em" viewBox="0 0 16 16"
										class="bi bi-briefcase-fill" fill="currentColor"
							...
							<a class="nav-link" href="<?= base_url('/Pengajuan'); ?>">
								<span class="nav-icon">
									...
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-text"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd"
											d="M5.5 7a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z" />
										<path fill-rule="evenodd"
											d="M5.5 9a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z" />
										<path fill-rule="evenodd"
											d="M2 2a2 2 0 0 1 2-2h6.5a2 2 0 0 1 2 2v11.5a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10.5 0H4a1 1 0 0 0-1 1v11.5a1 1 0 0 0 1 1h6.5a1 1 0 0 0 1-1V2z" />
									</svg>
								</span>
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('/Biaya'); ?>">
								<span class="nav-icon">
									...
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-wallet2"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M3 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H3zm0-1h10a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H3a3 3 0 0 1-3-3V4a3 3 0 0 1 3-3z" />
	...
	<!-- Tambahkan kode berikut di dalam tag <body>, setelah app-sidepanel -->
	<?php if (session()->get('role') == 'User'): ?>
		<style>
			/* Sembunyikan menu Akun dan Pegawai untuk user */
			.nav-link[href="<?= base_url('/akun'); ?>"],
			.nav-link[href="<?= base_url('/Pegawai'); ?>"] {
				display: none;
			}
		</style>
	<?php endif; ?>
